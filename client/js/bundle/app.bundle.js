...
/***/ function(module, exports) {
	...
	function registerSceneMain() {
	    AFRAME.registerComponent('scene-main', {
	        init: function init() {
	            var draggableElements = document.getElementById("test-sphere");
